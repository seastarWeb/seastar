...
use common\models\TblPromotions;
...
//------------------------------------------------------------------------------------------------//
    ...
    {
        $promos= SearchPromotion::getActive();
    //    $promotions=$promos->getModels();
        $haspromo=true;
        $snippets = Menu::getLeaves(1);
        $model = new Menu();
 ...
 *--------------------*/
    ...
    protected function findModel($id)
    {
        if (($model = Menu::findOne($id)) !== null) {
                ...
                throw new NotFoundHttpException('The menu requested page does not exist.');
                }
    }
}
